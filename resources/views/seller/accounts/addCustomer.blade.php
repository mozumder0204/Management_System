...
<title>Seller - ADD Customer</title>
					...
					<form method="POST">
						<fieldset>
							<div class="form-group">
								<input class="form-control" placeholder="Customer Name..." name="name" type="text" autofocus="">
							</div>
							<div class="form-group">
                            ...
                            <div class="form-group">
                                    <input class="form-control" placeholder="Credit Card No..." name="creditno" type="text" autofocus="">
                                </div>
