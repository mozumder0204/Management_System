...
<title>Seller - Daily Sells</title>
            ...
            <div class="login-panel panel panel-default">
                ...
                <div class="panel-body">
                        ...
                        <div class="form-group">
                            <input class="form-control" placeholder="Sells Point Name..." name="sp" type="text"
                            autofocus="">
                        </div>
                        <div class="form-group">
                                <select name="pname" class="form-control">
                                    <option value="name" disabled selected>Product Name</option>
                        ...
                        <div class="form-group">
                                <select name="cname" class="form-control">
                                    <option value="name" disabled selected>Customer Name</option>
                                    @foreach($customer as $cs)
                                        <option value="{{$cs['c_id']}}">{{$cs['c_name']}}</option>
                                    @endforeach
                                </select>
                        </div>
                        <div class="form-group">
